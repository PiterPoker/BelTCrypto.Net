...
[Obsolete("Этот класс реализует старую версию алгоритма. Рекомендуется использовать BelTWideBlock вместо него.")]
internal sealed class BelTWideBlockOld(IBelTBlockOld block) : IBelTWideBlockOld
{
